...
import it.water.repository.jpa.model.AbstractJpaExpandableTenantEntity;
...
//JPA
@Entity
@Table(uniqueConstraints = { @UniqueConstraint(columnNames = {"path", "fileName"}),@UniqueConstraint(columnNames = {"uid"}) })
...
public class Document extends AbstractJpaExpandableTenantEntity implements ProtectedEntity, SharedEntity {
